...
class User:
    ...
    @classmethod
    def edit_one_with_tvshows(cls, data):
        ...
        for result in results:
            ...
            temp_tvshow = {
                "id" : result['tvshows.id'],
                "name" : result['name'],
                "description" : result['description'],
                "network" : result['network'],
                "date_made" : result['date_made'],
                "user_id" : result['user_id'],
                "created_at" : result['tvshows.created_at'],
                "updated_at" : result['tvshows.updated_at']
            }
            user.tvshows.append(Tvshow(temp_tvshow))
        print(user.tvshows)
...
# @classmethod
    # def get_one_with_tvshows(cls, data):
