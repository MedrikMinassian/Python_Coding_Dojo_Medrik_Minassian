...
Select * From dojos where id= 4;(Select ninjas From dojos order by id Desc Limit 4);
-- Query: Retrieve all the ninjas from the last dojo
Select * From dojos where id = 6; (Select ninjas From dojos order by id Desc Limit 6);

-- Query: Retrieve the last ninja's dojo
SELECT * FROM ninjas order by id = 6; (SELECT dojo_id FROM ninjas ORDER BY id DESC LIMIT 6);
